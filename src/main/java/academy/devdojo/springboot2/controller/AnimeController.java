...
public class AnimeController {
	...
	tags = {"anime" })
	public ResponseEntity<Page<Anime>> list(@ParameterObject org.springframework.data.domain.Pageable pageable) {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Successfull Operation"),
